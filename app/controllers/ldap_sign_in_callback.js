...
const AccessTokenHandler = function (req, res) {
  return async (response) => {
    ...
    if (body.error && body.error === 'access_denied') {
      console.log('ldap_sign_in_callback AccessTokenHAndler error')
    ...
    try {
      ...
      // wie bekomme ich hier den user hin?
      ...
      // endpoint /api/v1/users aufrufen: holt oder legt user an
      axios
...
exports.get = async function (req, res) {
  console.log("get im ldap_sign_in_callback", req.body)
  ...
  // // var userPassword = md5(req.body.userpassword);
